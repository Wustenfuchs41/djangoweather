...
def home(request):
	...
	if request.method == 'POST':
		...
		api_request = requests.get('http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=' + zipcode + '&distance=1&API_KEY=DF9523C4-9021-4AD2-8C55-FB59FF492017')
		...
		# http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=1&API_KEY=DF9523C4-9021-4AD2-8C55-FB59FF492017
		...
		api_request = requests.get('http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=1&API_KEY=DF9523C4-9021-4AD2-8C55-FB59FF492017')
